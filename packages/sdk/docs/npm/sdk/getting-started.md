...
Your project should also use Tailwind CSS v4. See [Theme](./theme.md) for Tailwind configuration.
...
- [Hooks](./hooks.md) -- persistent state, settings, and terminal relay
- [Intents](./intents.md) -- declare commands for LLM, voice, and search
