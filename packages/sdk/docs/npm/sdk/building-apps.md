...
Enable inter-app data piping. See [Ports](./ports.md) for details.
...
- [Hooks](./hooks.md) -- persistent state, app settings, terminal relay
- [Intents](./intents.md) -- make commands discoverable by AI and search
- [Ports](./ports.md) -- pipe data between apps
- [Theme](./theme.md) -- design tokens and Tailwind setup
